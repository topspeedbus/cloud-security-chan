...
/**
 * 处理redis 高版本废弃conn.set问题
 */
@Component
public class ChanRedisTokenStore implements TokenStore {
    ...
    private String prefix = SecurityConstant.CHAN_PREFIX;

    public ChanRedisTokenStore(RedisConnectionFactory connectionFactory) {
